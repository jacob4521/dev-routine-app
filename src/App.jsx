                    ...
                    {urgentTasks.length > 0 ? (
                      urgentTasks.map((task, index) => (
                        <button
                          ...
                          key={task.id}
                          className="group flex w-full items-start justify-between gap-4 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-left transition hover:border-slate-300 hover:bg-slate-50"
                        >
                          <div>
                          ...
                          <span className="rounded-full bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-700 transition group-hover:bg-slate-200">
                            Open
                          </span>
                        </button>
                      ))
